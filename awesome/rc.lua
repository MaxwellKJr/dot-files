...
beautiful.init("/home/maxwellkjr/.config/awesome/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
  ...
  -- awful.tag({ "dev", "web", "files", "music", "chill" }, s, awful.layout.layouts[1])
  awful.tag({ " ", " ", " ", " ", "󰭹 ", "󰙯 ", " " }, s, awful.layout.layouts[1])
  ...
  beautiful.widget_date_color = "#FF0077"
  -- mytextclock.format = " %a %b %d %I:%M "
  --mytextclock.markup = "<span foreground='" ..
      -- beautiful.widget_date_color .. "'>" .. os.date(" %a %b %d %I:%M ") .. "</span>"
  ...
  s.mywibox:setup {
    ...
    s.mytasklist, -- Middle widget
    {
      ...
      net_speed_widget(),
      ram_widget(),
      { widget = wibox.container.margin, right = 1, },
      brightness_widget {
        type = 'arc',
...
globalkeys = gears.table.join(
  ...
  awful.key({}, "XF86AudioPlay", function() cmus_widget:play_pause() end,
    { description = "play track", group = "cmus" }),
  awful.key({}, "XF86AudioPause", function() cmus_widget:play_pause() end,
    { description = "pause track", group = "cmus" }),
  awful.key({}, "XF86AudioNext", function() cmus_widget:next_track() end,
    { description = "next track", group = "cmus" }),
  awful.key({}, "XF86AudioPrev", function() cmus_widget:prev_track() end,
...
awful.rules.rules = {
  ...
  -- Set Nemo to always map on the tag named "2" on screen 1.
  {
    rule = { class = "nemo" },
